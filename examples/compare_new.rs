...
use rs_backtester::strategies::{buy_n_hold_arc, rsi_strategy_arc, simple_sma_arc, sma_cross_arc};
use rs_backtester::utilities;
...
pub fn main() ->Result<(),Box<dyn Error>>{
    ...
    let sma = simple_sma_arc(quotes_arc.clone(),10);
